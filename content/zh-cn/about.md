...
<div style="position: fixed; bottom: 20px; left: 20px; z-index: 9999;">
    <a class="performance-link" href="/zh-cn/pages/performance/" style="display: block; width: 40px; height: 40px; background: rgba(0,0,0,0.1); border-radius: 50%; position: relative; transition: all 0.3s ease;">
